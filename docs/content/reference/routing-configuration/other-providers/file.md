...
| <a id="opt-http-routers-router-name-fallback" href="#opt-http-routers-router-name-fallback" title="#opt-http-routers-router-name-fallback">`http.routers.<router_name>.fallback`</a> | See [fallback routers](../http/routing/router.md#fallback-routers) for more information. | `true` |
...
| <a id="opt-tcp-routers-router-name-fallback" href="#opt-tcp-routers-router-name-fallback" title="#opt-tcp-routers-router-name-fallback">`tcp.routers.<router_name>.fallback`</a> | See [fallback routers](../tcp/routing/router.md#fallback-routers) for more information. | `true` |
