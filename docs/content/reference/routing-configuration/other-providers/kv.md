...
| <a id="opt-traefikhttproutersrouter-namefallback" href="#opt-traefikhttproutersrouter-namefallback" title="#opt-traefikhttproutersrouter-namefallback">`traefik/http/routers/<router_name>/fallback`</a> | See [fallback routers](../http/routing/router.md#fallback-routers) for more information. | `true` |
...
| <a id="opt-traefiktcproutersrouter-namefallback" href="#opt-traefiktcproutersrouter-namefallback" title="#opt-traefiktcproutersrouter-namefallback">`traefik/tcp/routers/<router_name>/fallback`</a> | See [fallback routers](../tcp/routing/router.md#fallback-routers) for more information. | `true` |
