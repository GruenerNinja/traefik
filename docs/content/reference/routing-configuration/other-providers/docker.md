...
| <a id="opt-traefik-http-routers-router-name-fallback" href="#opt-traefik-http-routers-router-name-fallback" title="#opt-traefik-http-routers-router-name-fallback">`traefik.http.routers.<router_name>.fallback`</a> | See [fallback routers](../http/routing/router.md#fallback-routers) for more information. | `true` |
...
| <a id="opt-traefik-tcp-routers-router-name-fallback" href="#opt-traefik-tcp-routers-router-name-fallback" title="#opt-traefik-tcp-routers-router-name-fallback">`traefik.tcp.routers.<router_name>.fallback`</a> | See [fallback routers](../tcp/routing/router.md#fallback-routers) for more information. | `true` |
